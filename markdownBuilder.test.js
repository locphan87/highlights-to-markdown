...
describe('markdownBuilder should', () => {
  test('create a md file with correct name', () => {
    const books = [{
    ...
    var markdownBookFile = fs.readFileSync('2015-02-21-scrum-and-xp-from-the-trenches.md', 'utf8');
    expect(markdownBookFile).toStrictEqual('');
  });
});